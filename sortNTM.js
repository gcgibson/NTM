...
jf.writeFile('./writetapeWeight.json', resultWeightingObject, function(err) {
            console.log(err)
    });
jf.writeFile('./readtapeWeights.json', resultReadObject, function(err) {
        console.log(err)
    });
jf.writeFile('./outputLayer.json', resultOutPutObject, function(err) {
            console.log(err)
    });
